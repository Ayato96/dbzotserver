...
<h1>
<a id="user-content-forgottenserver---" class="anchor" aria-hidden="true" href="#forgottenserver---">
<svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true">
<path fill-rule="evenodd" d="M7.775 3.275a.75.75 0 001.06 1.06l1.25-1.25a2 2 0 112.83 2.83l-2.5 2.5a2 2 0 01-2.83 0 .75.75 0 00-1.06 1.06 3.5 3.5 0 004.95 0l2.5-2.5a3.5 3.5 0 00-4.95-4.95l-1.25 1.25zm-4.69 9.64a2 2 0 010-2.83l2.5-2.5a2 2 0 012.83 0 .75.75 0 001.06-1.06 3.5 3.5 0 00-4.95 0l-2.5 2.5a3.5 3.5 0 004.95 4.95l1.25-1.25a.75.75 0 00-1.06-1.06l-1.25 1.25a2 2 0 01-2.83 0z">
</path>
</svg>
</a>forgottenserver <a href="https://travis-ci.org/otland/forgottenserver" title="Travis CI status" rel="nofollow">
...
<p>The Forgotten Server is a free and open-source MMORPG server emulator written in C++. It is a fork of the 
...
<p>If you need help, please visit the <a href="https://otland.net/forums/support.16/" rel="nofollow">
support forum on OTLand</a>. 
Our issue tracker is not a support forum, and using it as one will result in your issue being closed. If you were unable to get assistance in the support forum, you should consider 
<a href="https://otland.net/account/upgrades" rel="nofollow">becoming a premium user on OTLand
</a> which grants you access to the premium support forum and supports OTLand financially.</p>
...
<p>We use the <a href="https://github.com/otland/forgottenserver/issues">issue tracker on GitHub</a>. 
